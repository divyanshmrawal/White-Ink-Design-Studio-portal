...
if (firebaseConfig.projectId && firebaseConfig.apiKey) {
  try {
    ...
    messaging.onBackgroundMessage((payload) => {
      ...
      const title = payload.notification?.title || payload.data?.title || 'PlanForge Notification';
      const body =
        payload.notification?.body || payload.data?.body || payload.data?.message || 'You have a new alert.';
